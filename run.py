...
def get_content():
    ...
    return content
dash_app = dash.Dash(__name__, external_stylesheets=[dbc.themes.COSMO])
dash_app.layout  = get_content()

app = dash_app.server

@dash_app.callback(Output('dataUsage_chart', 'figure'),
...
@dash_app.callback(Output('dataUsageTrain_chart', 'figure'),
...
@dash_app.callback(Output('dataUsage_pieChart', 'figure'),
...
@dash_app.callback(Output('dataUsage_donutChart', 'figure'),
...
@dash_app.callback(Output('tbl1', 'data'),
            Input('train_dropdown', 'value'))
...
@dash_app.callback(Output('tbl2', 'data'),
            Input('wanProvider_dropdown', 'value'))
